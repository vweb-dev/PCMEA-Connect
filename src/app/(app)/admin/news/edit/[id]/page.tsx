...
export default function EditArticlePage() {
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        console.log({ ...values, id: articleId });
        toast({
    ...
    return (
        <div className="flex flex-col gap-8 max-w-2xl mx-auto">
            <div>
                ...
                <h1 className="text-4xl font-bold font-headline tracking-tight">Edit Article</h1>
                <p className="text-muted-foreground mt-2">Update the details of the news article below.</p>
            </div>
