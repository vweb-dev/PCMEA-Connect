...
export default function NewMemberPage() {
    ...
    const [avatarPreview, setAvatarPreview] = useState<string | null>("https://picsum.photos/100/100");
    const [logoPreview, setLogoPreview] = useState<string | null>("https://picsum.photos/120/120");
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        // The specialties would be split into an array, e.g., by comma.
        const finalValues = {
            ...values,
        ...
        toast({
            title: "Member Added!",
            description: "The new member has been successfully added to the directory.",
        });
    ...
    return (
        <div className="flex flex-col gap-8 max-w-2xl mx-auto">
            <div>
                ...
                <h1 className="text-4xl font-bold font-headline tracking-tight">Add New Member</h1>
                <p className="text-muted-foreground mt-2">Fill out the form below to add a new member to the directory.</p>
            </div>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <label htmlFor="avatar-upload" className="cursor-pointer">
                                        <Button type="button" variant="outline" asChild>
                                            <span><Upload className="mr-2" /> Upload Avatar</span>
                                        </Button>
                                    </label>
                                    {avatarPreview && (
