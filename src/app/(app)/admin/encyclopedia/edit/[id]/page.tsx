...
export default function EditEncyclopediaEntryPage() {
    ...
    const entry = encyclopediaData.find(e => e.id === entryId);
    ...
    useEffect(() => {
        if (entry) {
            form.reset({
                ...entry,
                material: entry.characteristics.material,
                knot: entry.characteristics.knot,
                design: entry.characteristics.design,
            });
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        console.log({ ...values, id: entryId });
        toast({
            title: "Entry Updated!",
            description: "The encyclopedia entry has been successfully updated.",
        });
    ...
    return (
        <div className="flex flex-col gap-8 max-w-2xl mx-auto">
            <div>
                ...
                <h1 className="text-4xl font-bold font-headline tracking-tight">Edit Encyclopedia Entry</h1>
                <p className="text-muted-foreground mt-2">Update the details of the rug encyclopedia entry below.</p>
            </div>
